...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between px-2 lg:justify-evenly md:px-4 items-center  shadow-sm bg-white z-5">
      ...
      <div className="py-2">
        <Link to={"/"}>
          <h1 className="text-2xl font-bold">Ajji Store</h1>
        </Link>
      </div>
      <div className="hidden lg:flex gap-6">
        ...
        <div className="group">
          <div className="flex items-center cursor-pointer">
            <Link className="py-2" to={"/iphones"}>
              iPhones
            </Link>
            <IoMdArrowDropdown />
          </div>
        ...
        <div className="group">
          <div className="flex items-center cursor-pointer">
            <Link className="py-2" to={"/airpods"}>
              AirPods
            </Link>
            <IoMdArrowDropdown />
          </div>
        ...
        <div className="group">
          <div className="flex items-center cursor-pointer">
            <Link className="py-2" to={"/accessories"}>
              Accessories
            </Link>
            <IoMdArrowDropdown />
          </div>
      ...
      <div className="flex items-center gap-3 lg:gap-6 md:gap-5">
        ...
        <div className="relative">
          ...
          <p className="absolute right-[-8px] top-[1px] w-4 text-center leading-4 bg-blue-500 text-white aspect-squre rounded-full text-[8px]">
            0
          </p>
        </div>
        <div className="relative">
          ...
          <p className="absolute right-[-2px] top-[2px] w-4 text-center leading-4 bg-blue-500 text-white aspect-squre rounded-full text-[8px]">
            0
          </p>
        </div>
        <Tooltip title="My Account">
          <Link to={"/account"}>
            {" "}
            <img className="w-5 cursor-pointer" src={user_icon} alt="user" />
          </Link>
        </Tooltip>
      </div>
      ...
      >
        ...
        <Link onClick={() => setShowMenuItems(false)} to={"/"}>
          <li className="p-3 text-[18px] font-semibold">Home</li>
        </Link>
        <hr />
        <Link onClick={() => setShowMenuItems(false)} to={"/iphones"}>
          <li className="p-3 text-[18px] font-semibold">iPhones</li>
        </Link>
        <hr />
        <Link onClick={() => setShowMenuItems(false)} to={"/mac"}>
          <li className="p-3 text-[18px] font-semibold">Mac</li>
        </Link>
        <hr />
        <Link onClick={() => setShowMenuItems(false)} to={"/ipad"}>
          <li className="p-3 text-[18px] font-semibold">iPad</li>
        </Link>
        <hr />
        <Link onClick={() => setShowMenuItems(false)} to={"/watch"}>
          <li className="p-3 text-[18px] font-semibold">Watch</li>
        </Link>
        <hr />
        <Link onClick={() => setShowMenuItems(false)} to={"/airpods"}>
          <li className="p-3 text-[18px] font-semibold">AirPods</li>
        </Link>
        <hr />
        <Link onClick={() => setShowMenuItems(false)} to={"/accessories"}>
          <li className="p-3 text-[18px] font-semibold">Accessories</li>
        </Link>
        <hr />
      </ul>
    </div>
